...
export default function App() {
  ...
  const runtimeLabel = activeBackendUrl.includes("127.0.0.1") || activeBackendUrl.includes("localhost") ? "desktop sidecar" : "mobile remote";
